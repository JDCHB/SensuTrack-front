<script>
    ...
    onMount(async () => {
        try {
            ...
            const response = await fetch(
                "https://proyectomascotas.onrender.com/get_GPS_Discapacitados/",
            );
    ...
    async function Ocultar() {
        ...
        let mostrar = document.getElementById("MostrarGPS");
    ...
    async function editar(id, a) {
        ...
        console.log(vid);
        let ocultar = document.getElementById("MostrarGPS");
        ...
        try {
            ...
            const response = await fetch(
                `https://proyectomascotas.onrender.com/get_GPS_Discapacitado/${vid}`,
                {
                    method: "GET",
                    headers: {
    ...
    async function actualizar() {
        ...
        let vserial = document.getElementById("apellidos").value;
                ...
                >
                    <thead>
                        <tr>
                            ...
                            >
                            <th class="px-4 py-2 border">Serial del GPS</th>
