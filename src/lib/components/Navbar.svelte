<nav class="navbar navbar-expand-lg navbar-light bg-light py-3">
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link text-dark fw-bold" href="/sobre_nosotros">
          <i class="bi bi-house-door"></i> Sobre Nosotros
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark fw-bold" href="/preguntas_frecuentes">
          <i class="bi bi-question-circle"></i> Preguntas Frecuentes
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark fw-bold" href="/contacto">
