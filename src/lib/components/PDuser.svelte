    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-4">
                <div class="card bg-light shadow-sm border-0 px-2 py-3 mb-4">
                    <div class="text-center">
                        <img src="/producto1.jpg" class="img-fluid" alt="Collares">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-12 col-md-4">
                <div class="card bg-light shadow-sm border-0 px-2 py-3 mb-4">
                    <div class="text-center">
                        <img src="/Producto3.jpg" class="img-fluid" alt="Collares">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Collares</h5>
                        <p>Los collares hechos con última tecnología para sentirte seguro</p>
            ...
            <div class="col-12 col-md-4">
                <div class="card bg-light shadow-sm border-0 px-2 py-3 mb-4">
                    <div class="text-center">
                        <img src="/producto5.jpeg" class="img-fluid" alt="Collares">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Collares</h5>
                        <p>Los collares hechos con última tecnología para sentirte seguro</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h2>Lo mejor para tu amigo incondicional</h2>
                <p>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed possimus necessitatibus cupiditate! Temporibus, optio dolorem? Rerum inventore esse maiores necessitatibus molestias nostrum asperiores, deserunt est sapiente modi mollitia assumenda doloremque?
                </p>
                <div>
                    <img src="/localizador-GPS-perro.webp" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="secction-header text-center pb-2 pb-lg-5">
                    <h2>Contacto</h2>
                    <p>
                        Contáctenos para más información <br> y esté tranquilo con tu amigo fiel
                    </p>
                </div>
            </div>
        </div>
