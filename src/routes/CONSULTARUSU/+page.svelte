...
<html lang="en">
    ...
    <script>
        ...
        function lista() {
            ...
            axios({
                method: "GET",
                url: "http://127.0.0.1:3000/getusuarios",
            })
                .then(function (response) {
                    let tabla = $("#tablausuario").DataTable();
                    tabla.clear();
                    for (i = 0; i < response.data.length; i++) {
                        if (response.data[i].id_rol == 2) {
                            namerol_v = "Administrativo";
                            console.log("ss");
                        } else {
                            namerol_v = "Usuario";
                        }
                        ...
                        tabla.row.add([
                            ...
                            '<a class="btn btn-outline-info" onclick="administrativo(\' ' +
                                response.data[i].id +
                                ' \')">  <b>Administrativo<b>    <a/> <a class="btn btn-outline-success" onclick="user(\' ' +
                                response.data[i].id +
                                " ')\"><b>Usuario<b><a/>  ", /// cuarto elemento
